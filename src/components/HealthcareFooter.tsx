      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          <div>
            ...
            <p className="font-mono text-xs text-muted-foreground mt-3">60 Strategic Chapters · 8 Volumes · 58 RCM Playbooks · 2025–2026</p>
          </div>
          <div>
          ...
          <div>
            ...
            <div className="flex gap-3 mt-3">
              ...
              <a href="https://github.com/kalilurrahman" target="_blank" rel="noopener noreferrer" className="text-xs text-primary hover:text-teal-light transition-colors flex items-center gap-1 font-mono">
