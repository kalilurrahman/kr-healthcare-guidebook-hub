...
const insights: Insight[] = [
  {
    ...
    stat: "$7.7T by 2033",
    detail: "CMS actuaries project NHE to grow at 5.6% CAGR, outpacing GDP (4.3%), reaching 19.7% of GDP by 2032.",
  ...
  },
  {
    ...
    stat: "54% of Medicare",
    detail: "MA enrollment reached 32.8M in 2025 — more than half of eligible Medicare beneficiaries; risk-based capabilities are table stakes.",
